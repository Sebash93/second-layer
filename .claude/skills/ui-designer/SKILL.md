...
### Step 5: Update design-concepts.md
- After any design modification, update `design-concepts.md` to reflect the changes
- Keep it in sync with the current state of all design decisions, tokens, components, and layouts
